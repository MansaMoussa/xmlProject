...
if __name__ == '__main__':
    ...
    #  impl = getDOMImplementation()
    # newdocreponse = impl.createDocument(None, "Copie", None)
    # newrootreponse = newdocreponse.documentElement

    # newnodecontenureponse = newdocreponse.createElement("contenu")
    # nodeList= newdocreponse.createElement("Question")
    # newnodereponse2 = newdocreponse.createElement("Question")
